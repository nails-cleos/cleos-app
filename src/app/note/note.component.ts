...
export class NoteComponent {
  ...
  private subErrorsSignal: Signal<IError[] | undefined> =
    this.noteStore.subErrors;

  allProfessionalsSignal: Signal<IUserAll[] | undefined> =
    this.userStore.professionals;
