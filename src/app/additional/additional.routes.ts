...
const children: Routes = [
  ...
  { path: 'add', component: AdditionalCreatePageComponent, canActivate: [authGuard], data: { roles: [Role.admin] } },
  { path: ':id', component: AdditionalDetailsPageComponent, canActivate: [authGuard], data: { roles: [Role.admin] } },
];
