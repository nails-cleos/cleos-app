...
export class TotalSummaryComponent {
  ...
  primaryOperation = computed(() => {
    ...
    return [
      {
        key: 'gross',
        label: 'SUMMARY.MONTHLY.TABLE.GROSS',
        left: totals.income,
        right: totals.expense,
        result: totals.totalsWithoutCash,
      },
      {
        key: 'btw',
        label: 'SUMMARY.MONTHLY.TABLE.BTW',
        left: totals.income,
        right: totals.expense,
        result: totals.totalsWithoutCash,
      },
      {
        key: 'net',
        label: 'SUMMARY.MONTHLY.TABLE.NET',
        left: totals.income,
        right: totals.expense,
        result: totals.totalsWithoutCash,
      },
