  ...
  private getRangeLabel = (
    ...
    if (length === 0 || pageSize === 0) {
      return this.translateService.instant(
        'COMMON.PAGINATOR.RANGE_PAGE_LABEL_1',
        { length },
      );
    }
    ...
    return this.translateService.instant(
      'COMMON.PAGINATOR.RANGE_PAGE_LABEL_2',
