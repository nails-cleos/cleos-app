...
export class DocumentService {
  ...
  getDocument = (id: string): Observable<IDocument | undefined> => this.http.get<IDocument>(
  ...
  view = (
    ...
    return this.http.get(toUrl(this.urlV1, id, 'file'), { headers, responseType: 'blob' });
  };

  deleteDocument = (id: string): Observable<void> => this.http.delete<void>(toUrl(this.urlV1, id));
