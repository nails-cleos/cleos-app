...
export class ReservationService {
  ...
  public addNote(id: string, note?: string, customerNote?: string): Observable<IReservation> {
    return this.http.patch<IReservation>(`${ this.urlV1 }/${ id }/notes`, { note, customerNote });
  }
