...
export class TrackingService {
  ...
  getTrackingByReservationId = (reservationId: string): Observable<ITracking> =>
    this.http.get<ITracking>(
  ...
  ): Observable<ITracking> =>
    this.http.post<ITracking>(
      toUrl(this.urlV1, 'reservations', reservationId),
      {},
    );
