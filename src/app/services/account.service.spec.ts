...
describe('AccountService', () => {
  ...
  let httpSpy: Pick<HttpClient, 'get' | 'post' | 'patch'> & {
  ...
  describe('getTransactionsByAccountId', () => {
    it('should fetch transactions with correct parameters', () => {
      ...
      httpSpy.get.mockReturnValue(of(mockResult));

      service
        .getTransactionsByAccountId('1', 0, 'name', 'asc', 5)
        .subscribe((result) => {
  ...
  it('should fetch account by id', () => {
    httpSpy.get.mockReturnValue(of(mockAccount));
  ...
  it('should fetch transaction by id', () => {
    httpSpy.get.mockReturnValue(of(mockTransaction));
    ...
    expect(httpSpy.get).toHaveBeenCalledWith(
      'v1/accounts/ac-1/transactions/tr-1',
      { ...skipLoadingOverlay() },
    );
  });
