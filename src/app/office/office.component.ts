...
import { clean, createOffice, getAllManager, getOffice, updateOffice } from '../store/office.actions';
...
export class OfficeComponent implements OnInit, OnDestroy {
  ...
  private getManagers = (): void => this.store.dispatch(getAllManager());

  private getOffice = (): void => {
    if (!this.office) {
      this.store.dispatch(getOffice({ id: this.id! }));
    }
  };
