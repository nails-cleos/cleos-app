    ...
    (
      ...
      return {
        ...
        loadMyOffices(): void {
          ...
          loadMyOfficesSubscription = officeService
            .getAllMyOffices()
            .subscribe({
              next: (value) =>
                patchState(store, {
        ...
        create(office: IOffice): void {
          ...
          createSubscription = officeService.createOffice(office).subscribe({
            next: (response: IApiResponse) =>
              patchState(store, {
                response: {
                  message: translateService.instant('OFFICE.CREATED', {
                    name: response.name,
                  }),
        ...
        update(id: string, office: IOffice): void {
          ...
          updateSubscription = officeService
        ...
        delete(id: string, name: string): void {
          ...
          deleteSubscription = officeService.deleteOffice(id).subscribe({
            next: () =>
              patchState(store, {
                response: {
                  message: translateService.instant('OFFICE.DELETED.MESSAGE', {
                    name,
                  }),
                  redirect: 'offices',
                  reload: true,
