    ...
    (
      ...
      return {
        ...
        loadPage({ page, sort, direction, size }: PageRequest): void {
          ...
          loadPageSubscription = roomService
            .getRoomsPage(page, sort, direction, size)
            .subscribe({
              next: (value) =>
                patchState(store, {
        ...
        updateServices(id: string, prices: IServicePrice[]): void {
          ...
          updateServicesSubscription = roomService
            .updateServices(id, prices)
            .subscribe({
              next: () =>
                patchState(store, {
        ...
        loadCustomers(id: string): void {
          ...
          loadCustomersSubscription = roomService
            .getAllCustomersInfo(id)
            .subscribe({
              next: (customers) =>
