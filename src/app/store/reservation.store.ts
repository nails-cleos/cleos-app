  ...
  withMethods(
    (
      ...
      const changeState = ({
        ...
        state,
        date,
      }: ChangeStateParams): void => {
        changeStateSubscription?.unsubscribe();
        patchState(store, { response: undefined, isLoading: true });

        changeStateSubscription = reservationService
          .changeState(id, event, extras)
          .subscribe({
            next: (response) => {
      ...
      return {
        ...
        loadPage({
          ...
          all,
          professionalId,
        }: ReservationPageRequest): void {
          loadPageSubscription?.unsubscribe();
          patchState(store, { data: undefined, isLoading: true });

          loadPageSubscription = reservationService
            .loadPage(page, sort, direction, size, all, roomId, professionalId)
            .subscribe({
              next: (value) =>
                patchState(store, {
        ...
        loadAllFiltered({
          ...
          userId,
          states,
        }: ReservationFilteredRequest): void {
          loadAllFilteredSubscription?.unsubscribe();
          patchState(store, { data: undefined, isLoading: true });

          loadAllFilteredSubscription = reservationService
            .loadAllFiltered(page, sort, direction, size, userId, states)
            .subscribe({
              next: (value) =>
                patchState(store, {
                  data: { kind: 'pagination', value },
        ...
        loadUpcoming(): void {
          ...
          loadUpcomingSubscription = reservationService
            .loadUpcoming()
            .subscribe({
              next: (value) =>
                patchState(store, {
                  data: { kind: 'customerReservation', value },
                  isLoading: false,
                }),
              error: patchError,
            });
        ...
        loadAllByCustomer({ sort, direction, page, size }: PageRequest): void {
          ...
          loadAllByCustomerSubscription = reservationService
            .loadAllByCustomer(page, sort, direction, size)
            .subscribe({
              next: (value) =>
                patchState(store, {
                  data: { kind: 'customerReservation', value },
        ...
        loadAllByRoom(
          ...
          loadAllByRoomSubscription = reservationService
            .loadAllByRoom(days, date, roomId, professionalId)
            .subscribe({
              next: (calendar) =>
                patchState(store, { calendar, isLoading: false }),
              error: patchError,
            });
        },
        ...
        loadCalendar(
          ...
          loadCalendarSubscription = reservationService
            .loadCalendar(roomId, days, dates, professionalId)
            .subscribe({
              next: (calendar) =>
                patchState(store, { calendar, isLoading: false }),
              error: patchError,
        ...
        loadAvailability(
          ...
          loadAvailabilitySubscription = reservationService
            .customerSearch(
              roomId,
              treatmentId,
              date,
            ...
            .subscribe({
              next: (availability) =>
                patchState(store, { availability, isLoading: false }),
              error: patchError,
            });
        },
        ...
        loadById(id: string): void {
          ...
          loadByIdSubscription = reservationService
            .getReservation(id)
            .subscribe({
              next: (selected) => {
        ...
        loadHistory(id: string): void {
          ...
          loadHistorySubscription = reservationService
            .loadHistory(id)
            .subscribe({
              next: (value) =>
                patchState(store, {
        ...
        create(reservation: IReservation, role: Role): void {
          ...
          createSubscription = reservationService
        ...
        updateById(id: string, reservation: IReservation, role: Role): void {
          ...
          updateByIdSubscription = reservationService
        ...
        delete(id: string, timestamp: string, timeZone: string): void {
          ...
          deleteSubscription = reservationService
        ...
        loadReview(id: string): void {
          ...
          loadReviewSubscription = reservationService.getReview(id).subscribe({
        ...
        updateNote(
          ...
          updateNoteSubscription = reservationService
        ...
        updateDiscount(id: string, discountId: string): void {
          ...
          updateDiscountSubscription = reservationService
        ...
        updateTimestamp(
          ...
          updateTimestampSubscription = reservationService
        ...
        updateColor(id: string, colorId: string): void {
          ...
          updateColorSubscription = reservationService
            .updateReservationColor(id, colorId)
            .subscribe({
              next: (response) =>
                stateSuccess(response.id, 'RESERVATION.STATE.CHANGE_COLOR'),
              error: patchError,
            });
        },
        ...
        updateCustomer(id: string, colorId: string): void {
          ...
          updateCustomerSubscription = reservationService
            .updateReservationCustomer(id, colorId)
            .subscribe({
              next: (response) =>
                stateSuccess(response.id, 'RESERVATION.STATE.CHANGE_CUSTOMER'),
              error: patchError,
            });
        },
      };
