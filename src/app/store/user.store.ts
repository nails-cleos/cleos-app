    ...
    (
      ...
      return {
        ...
        loadPage({
          ...
          size,
          filter,
        }: userPageRequest): void {
          loadPageSubscription?.unsubscribe();
          patchState(store, { data: undefined, isLoading: true });

          loadPageSubscription = userService
            .getUsersPage(page, sort, direction, size, filter)
            .subscribe({
        ...
        loadProfessionals(): void {
          ...
          loadProfessionalsSubscription = userService
            .getProfessionals()
            .subscribe({
              next: (professionals) =>
                patchState(store, { professionals, isLoading: false }),
              error: patchError,
            });
        },
        ...
        loadManagers(): void {
          ...
          loadManagersSubscription = userService.getManagers().subscribe({
            next: (managers) =>
              patchState(store, { managers: managers, isLoading: false }),
            error: patchError,
          });
        },
        ...
        loadRoomsByProfessionalId(professionalId: string): void {
          ...
          loadRoomsByProfessionalIdSubscription = userService
            .getAllRoomsByProfessionalId(professionalId)
            .subscribe({
        ...
        loadDisabledUsers(): void {
          ...
          loadDisabledUsersSubscription = userService
            .getAllDisableUsers()
            .subscribe({
              next: (users) =>
        ...
        loadOverview(id: string): void {
          ...
          loadOverviewSubscription = userService
            .getCustomerOverview(id)
            .subscribe({
              next: (overview) =>
                patchState(store, { overview, isLoading: false }),
              error: patchError,
            });
        },
        ...
        updateMyPhoto(file: string): void {
          ...
          updateMyPhotoSubscription = userService
            .updateMyPhoto(file)
            .subscribe({
              next: (response) => {
                patchState(store, {
        ...
        mergeUsers(oldUserId: string, newUserId: string): void {
          ...
          mergeUsersSubscription = userService
        ...
        getCustomerInformation(id: string): void {
          ...
          getCustomerInformationSubscription = userService
            .getCustomerInformation(id)
            .subscribe({
              next: (customerInfo) =>
                patchState(store, { customerInfo, isLoading: false }),
              error: patchError,
            });
        },
      };
