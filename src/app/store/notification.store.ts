      ...
      return {
        ...
        loadPage({ page, sort, direction, size }: PageRequest): void {
          ...
          loadPageSubscription = notificationService
            .getNotificationsPage(page, sort, direction, size)
            .subscribe({
        ...
        read(id: string): void {
          ...
          readSubscription = notificationService
            .readNotification(id)
            .subscribe({
              next: (dataRead) => {
        ...
        delete(notification: INotification): void {
          ...
          deleteSubscription = notificationService
            .deleteNotification(notification.id)
            .subscribe({
              next: () =>
                patchState(store, {
                  dataDeleted: notification,
                  isLoading: false,
                }),
              error: patchError,
            });
        ...
        subscribeNotification(token: string): void {
          ...
          subscribeNotificationSubscription = notificationService
