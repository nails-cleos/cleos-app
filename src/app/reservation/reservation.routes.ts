...
const children: Routes = [
  ...
  { path: 'invoices', component: InvoiceComponent, canActivate: [authGuard], data: { roles: [Role.admin, Role.manager, Role.professional] } },
  { path: 'calendar', component: CalendarComponent, canActivate: [authGuard], data: { roles: [Role.admin, Role.manager, Role.professional] } },
  { path: '', component: ReservationComponent, canActivate: [authGuard], data: { roles: [Role.admin, Role.manager, Role.roomAdmin, Role.professional] } },
  { path: ':id/edit', component: ReservationComponent, canActivate: [authGuard], data: { roles: [Role.admin, Role.manager, Role.roomAdmin, Role.professional] } },
