...
export class ReservationCloneDialogComponent {
  ...
  private readonly dialogRef: MatDialogRef<ReservationCloneDialogComponent> =
    inject(MatDialogRef<ReservationCloneDialogComponent>);
  ...
  doAction() {
    this.dialogRef.close({
      date: this.getForm.date.value,
      time: this.getForm.time.value,
    });
  }
