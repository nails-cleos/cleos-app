...
export const environment = {
  ...
  googleClientId:
    '174727853234-3pdb4doq776uuklfr7jsfp5ll33ork6c.apps.googleusercontent.com',
  facebookClientId: '523962545388946',
  firebase: {
    apiKey: 'AIzaSyCQw4--OYnNQTpsLe9yoaqVnT4z_csjnrk',
    authDomain: 'auth.nailscleos.nl',
    ...
    vapidKey:
      'BKiso9gE3_8fIrVVtY1pKS2vC6a93hAYOGMPlqVUBBUCVmuAtEtDw98El0Z-YQFIpEL_VsCbwYGiz05xzJnaWJY',
    databaseURL:
