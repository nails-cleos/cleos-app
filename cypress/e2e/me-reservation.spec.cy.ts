...
devices.forEach(({ name, width, height }) => {
  describe(`Me reservation in ${name}`, () => {
    ...
    context('Create', () => {
      ...
      it('should create a reservation from the customer flow', () => {
        ...
        cy.get('[data-cy="group-input"]').should(
          'have.value',
          'Biab Treatment ',
        );
        ...
        cy.contains('.availability-grid button', '13:30').click({
          force: true,
        });
  ...
  context('View', () => {
    describe(`Me reservation with ${name}`, () => {
      ...
      it('should render customer upcoming reservation and reservation list', () => {
        ...
        cy.get('.upcoming-section')
          ...
          .within(() => {
            ...
            cy.contains('.price-row', 'Powder').should(
              'contain.text',
              '€ 15.00',
            );
      ...
      it('should open reservation detail from customer reservation view', () => {
        ...
        cy.get('app-reservation-detail-skeleton').should('not.exist');
